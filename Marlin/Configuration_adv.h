 ...
 */
   ...
   */
  #define THERMAL_PROTECTION_VARIANCE_MONITOR // TL
...
// @section bltouch
   ...
   */
  #define BLTOUCH_HS_MODE true // TL
 ...
 */
// #define INPUT_SHAPING_X // TL
// #define INPUT_SHAPING_Y // TL
  ...
  // #define SHAPING_MENU       // TL      // Add a menu to the LCD to set shaping parameters.
#endif

 ...
 * :[-2, -1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT_2 3 // TL
#define BAUDRATE_2 250000   // TL :[2400, 9600, 19200, 38400, 57600, 115200, 250000, 500000, 1000000] Enable to override BAUDRATE
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 20, 25 } // TL
 ...
 */
#define Z_MIN_PROBE_PIN PB1  // TL // Pin 32 is the RAMPS default
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -14.4, -0.75 } // TL
...
#define Z_PROBE_FEEDRATE_FAST (20*60) // TL
...
#define Z_CLEARANCE_BETWEEN_PROBES  3 // TL Z Clearance between probe points
...
#define Z_HOMING_HEIGHT  5  // TL // (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ...
 ...
 */
#define FILAMENT_RUNOUT_SENSOR  // TL
#if ENABLED(FILAMENT_RUNOUT_SENSOR)
  #define FIL_RUNOUT_ENABLED_DEFAULT true // Enable the sensor on startup. Override with M412 followed by M500.
  #define NUM_RUNOUT_SENSORS   1          // Number of sensors, up to one per extruder. Define a FIL_RUNOUT#_PIN for each.

  #define FIL_RUNOUT_STATE     HIGH // TL // Pin state indicating that filament is NOT present.
...
#define AUTO_BED_LEVELING_BILINEAR // TL
...
#define MANUAL_X_HOME_POS 3 // TL
#define MANUAL_Y_HOME_POS -14 // TL
...
#define HOMING_FEEDRATE_MM_M { (133 * 60), (133 * 60), (10 * 60) } // TL
